...
import functools
import math
from typing import (Any, TypeVar, List, Callable, Tuple, MutableSequence)
...
from .option import (some, Option, default_arg, value as value_1)
...
def fill(target: List[_T], target_index: int, count: int, value: _T=None) -> List[_T]:
...
def try_last(array: List[_T]) -> Option[_T]:
    if len(array) == 0:
        return None
...
def where(predicate: Callable[[__A], bool], array: List[__A]) -> List[__A]:
    return list(builtins.filter(predicate, array))
...
def empty(cons: Cons_1[__A]) -> List[__A]:
    return Helpers_allocateArrayFromCons(cons, 0)
...
def index_of(array: List[_T], item_1: _T, start: Option[int]=None, count: Option[int]=None) -> int:
...
def find(predicate: Callable[[_T], bool], array: List[_T]) -> _T:
    match_value : Option[_T] = next((x for x in array if (predicate)(x)), None)
...
def try_find(predicate: Callable[[_T], bool], array: List[_T]) -> Option[_T]:
...
def try_find_index(predicate: Callable[[_T], bool], array: List[_T]) -> Option[int]:
    match_value : int = (next((i for i, x in enumerate(array) if (predicate)(x)), -1)) or 0
    if match_value > -1:
        return match_value
...
def pick(chooser: Callable[[__A], Option[__B]], array: List[__A]) -> __B:
    def loop(i_mut: int, chooser: Callable[[__A], Option[__B]]=chooser, array: List[__A]=array) -> Any:
        while True:
            (i,) = (i_mut,)
            if i >= len(array):
                return index_not_found()
                ...
                match_value : Option[__B] = chooser(array[i])
...
def try_pick(chooser: Callable[[__A], Option[__B]], array: List[__A]) -> Option[__B]:
    def loop(i_mut: int, chooser: Callable[[__A], Option[__B]]=chooser, array: List[__A]=array) -> Option[Any]:
        while True:
            (i,) = (i_mut,)
            if i >= len(array):
                return None
...
def find_back(predicate: Callable[[__A], bool], array: List[__A]) -> __A:
    def loop(i_mut: int, predicate: Callable[[__A], bool]=predicate, array: List[__A]=array) -> Any:
        while True:
            (i,) = (i_mut,)
            if i < 0:
                return index_not_found()
...
def try_find_back(predicate: Callable[[__A], bool], array: List[__A]) -> Option[__A]:
    def loop(i_mut: int, predicate: Callable[[__A], bool]=predicate, array: List[__A]=array) -> Option[Any]:
        while True:
            (i,) = (i_mut,)
            if i < 0:
                return None
...
def find_last_index(predicate: Callable[[__A], bool], array: List[__A]) -> int:
    def loop(i_mut: int, predicate: Callable[[__A], bool]=predicate, array: List[__A]=array) -> int:
        while True:
            (i,) = (i_mut,)
            if i < 0:
                return -1
...
def find_index_back(predicate: Callable[[__A], bool], array: List[__A]) -> int:
    def loop(i_mut: int, predicate: Callable[[__A], bool]=predicate, array: List[__A]=array) -> int:
        while True:
            (i,) = (i_mut,)
            if i < 0:
...
def try_find_index_back(predicate: Callable[[__A], bool], array: List[__A]) -> Option[int]:
    def loop(i_mut: int, predicate: Callable[[__A], bool]=predicate, array: List[__A]=array) -> Option[int]:
        while True:
            (i,) = (i_mut,)
            if i < 0:
                return None
...
def choose(chooser: Callable[[_T], Option[_U]], array: List[_T], cons: Cons_1[_U]) -> List[_U]:
    res : List[_U] = []
    for i in range(0, (len(array) - 1) + 1, 1):
        match_value : Option[_U] = chooser(array[i])
        if match_value is not None:
    ...
    if equals_1(cons, None):
        ...
        def arrow_49(x: _U=None, chooser: Callable[[_T], Option[_U]]=chooser, array: List[_T]=array, cons: Cons_1[_U]=cons) -> _U:
            return x
...
def fold_indexed(folder: Callable[[int, _STATE, _T], _STATE], state: _STATE, array: List[_T]) -> _STATE:
    def arrow_50(delegate_arg0: _STATE, delegate_arg1: Any, delegate_arg2: int, folder: Callable[[int, _STATE, _T], _STATE]=folder, state: _STATE=state, array: List[_T]=array) -> _STATE:
...
def fold(folder: Callable[[_STATE, _T], _STATE], state: _STATE, array: List[_T]) -> _STATE:
    def arrow_51(acc: _STATE, x: Any=None, folder: Callable[[_STATE, _T], _STATE]=folder, state: _STATE=state, array: List[_T]=array) -> _STATE:
        return folder(acc, x)
...
def permute(f: Callable[[int], int], array: List[_T]) -> List[_T]:
    ...
    def arrow_52(i: int, x: Any=None, f: Callable[[int], int]=f, array: List[_T]=array) -> None:
        j : int = f(i) or 0
...
def set_slice(target: List[_T], lower: Option[int], upper: Option[int], source: List[_T]) -> None:
...
def sort_in_place_by(projection: Callable[[_A], _B], xs: List[_A], comparer: IComparer[_B]) -> None:
    def arrow_53(x: _A, y: _A=None, projection: Callable[[_A], _B]=projection, xs: List[_A]=xs, comparer: IComparer[_B]=comparer) -> int:
...
def sort_in_place(xs: List[_T], comparer: IComparer[_T]) -> None:
    def arrow_54(x: _T, y: _T=None, xs: List[_T]=xs, comparer: IComparer[_T]=comparer) -> int:
...
def sort(xs: List[_T], comparer: IComparer[_T]) -> List[_T]:
    xs_1 : List[_T] = xs[:]
    def comparer_1(x: _T, y: _T=None, xs: List[_T]=xs, comparer: IComparer[_T]=comparer) -> int:
        return comparer.Compare(x, y)
...
def sort_by(projection: Callable[[_A], _B], xs: List[_A], comparer: IComparer[_B]) -> List[_A]:
    xs_1 : List[_A] = xs[:]
    def expr_55():
        def comparer_1(x: _A, y: _A=None, projection: Callable[[_A], _B]=projection, xs: List[_A]=xs, comparer: IComparer[_B]=comparer) -> int:
            return comparer.Compare(projection(x), projection(y))
...
def unfold(generator: Callable[[_STATE], Option[Tuple[_T, _STATE]]], state: _STATE=None) -> List[_T]:
    res : List[_T] = []
    def loop(state_1_mut: Any=None, generator: Callable[[_STATE], Option[Tuple[_T, _STATE]]]=generator, state: _STATE=state) -> None:
        while True:
            (state_1,) = (state_1_mut,)
            match_value : Option[Tuple[_T, _STATE]] = generator(state_1)
            if match_value is not None:
                x : _T = match_value[0]
...
def unzip(array: List[Tuple[__A, __B]]) -> Tuple[List[__A], List[__B]]:
    len_1 : int = len(array) or 0
    res1 : List[__A] = [None]*len_1
    res2 : List[__B] = [None]*len_1
    def arrow_57(i: int, tupled_arg: Tuple[__A, __B], array: List[Tuple[__A, __B]]=array) -> None:
        res1[i] = tupled_arg[0]
        res2[i] = tupled_arg[1]
...
def unzip3(array: List[Tuple[__A, __B, __C]]) -> Tuple[List[__A], List[__B], List[__C]]:
    len_1 : int = len(array) or 0
    res1 : List[__A] = [None]*len_1
    res2 : List[__B] = [None]*len_1
    res3 : List[__C] = [None]*len_1
    def arrow_58(i: int, tupled_arg: Tuple[__A, __B, __C], array: List[Tuple[__A, __B, __C]]=array) -> None:
        res1[i] = tupled_arg[0]
        res2[i] = tupled_arg[1]
        res3[i] = tupled_arg[2]
...
def try_exactly_one(array: List[_T]) -> Option[_T]:
    if len(array) == 1:
        return some(array[0])
...
def try_head(array: List[_T]) -> Option[_T]:
    if len(array) == 0:
        return None
...
def item(index: int, array: List[__A]) -> __A:
    return array[index]


def try_item(index: int, array: List[_T]) -> Option[_T]:
    if True if (index < 0) else (index >= len(array)):
        return None
...
def fold_back_indexed(folder: Callable[[int, _T, _STATE], _STATE], array: List[_T], state: _STATE=None) -> _STATE:
    def arrow_59(delegate_arg0: _STATE, delegate_arg1: Any, delegate_arg2: int, folder: Callable[[int, _T, _STATE], _STATE]=folder, array: List[_T]=array, state: _STATE=state) -> _STATE:
        return folder(delegate_arg2, delegate_arg1, delegate_arg0)
    
    return array.reduceRight((arrow_59, state))


def fold_back(folder: Callable[[_T, _STATE], _STATE], array: List[_T], state: _STATE=None) -> _STATE:
    def arrow_60(acc: _STATE, x: Any=None, folder: Callable[[_T, _STATE], _STATE]=folder, array: List[_T]=array, state: _STATE=state) -> _STATE:
        return folder(x, acc)
    
    return functools.reduce(arrow_60, array[::-1], state)


def fold_indexed2(folder: Callable[[int, __A, __B, __C], __A], state: __A, array1: List[__B], array2: List[__C]) -> __A:
    acc : __A = state
    if len(array1) != len(array2):
...
def fold2(folder: Callable[[_STATE, _T1, _T2], _STATE], state: _STATE, array1: List[_T1], array2: List[_T2]) -> _STATE:
    def arrow_61(_arg1: int, acc: _STATE, x: Any, y: Any=None, folder: Callable[[_STATE, _T1, _T2], _STATE]=folder, state: _STATE=state, array1: List[_T1]=array1, array2: List[_T2]=array2) -> _STATE:
        return folder(acc, x, y)
    
    return fold_indexed2(arrow_61, state, array1, array2)


def fold_back_indexed2(folder: Callable[[int, _T1, _T2, _STATE], _STATE], array1: List[_T1], array2: List[_T2], state: _STATE=None) -> _STATE:
    acc : _STATE = state
    if len(array1) != len(array2):
        different_lengths()
...
def fold_back2(f: Callable[[_T1, _T2, _STATE], _STATE], array1: List[_T1], array2: List[_T2], state: _STATE=None) -> _STATE:
    def arrow_62(_arg1: int, x: Any, y: Any, acc: _STATE=None, f: Callable[[_T1, _T2, _STATE], _STATE]=f, array1: List[_T1]=array1, array2: List[_T2]=array2, state: _STATE=state) -> _STATE:
        return f(x, y, acc)
...
def for_all2(predicate: Callable[[__A, __B], bool], array1: List[__A], array2: List[__B]) -> bool:
    def arrow_63(acc: bool, x: Any, y: Any=None, predicate: Callable[[__A, __B], bool]=predicate, array1: List[__A]=array1, array2: List[__B]=array2) -> bool:
...
def exists(predicate: Callable[[__A], bool], array: List[__A]) -> bool:
    return exists_offset(predicate, array, 0)


def exists_offset2(predicate_mut: Callable[[__A, __B], bool], array1_mut: List[__A], array2_mut: List[__B], index_mut: int) -> bool:
    while True:
...
def exists2(predicate: Callable[[__A, __B], bool], array1: List[__A], array2: List[__B]) -> bool:
    if len(array1) != len(array2):
        different_lengths()
...
def max_by(projection: Callable[[_A], _B], xs: List[_A], comparer: IComparer[_B]) -> _A:
    def arrow_64(x: _A, y: _A=None, projection: Callable[[_A], _B]=projection, xs: List[_A]=xs, comparer: IComparer[_B]=comparer) -> _A:
...
def max(xs: List[_A], comparer: IComparer[_A]) -> _A:
    def arrow_65(x: _A, y: _A=None, xs: List[_A]=xs, comparer: IComparer[_A]=comparer) -> _A:
...
def min_by(projection: Callable[[_A], _B], xs: List[_A], comparer: IComparer[_B]) -> _A:
    def arrow_66(x: _A, y: _A=None, projection: Callable[[_A], _B]=projection, xs: List[_A]=xs, comparer: IComparer[_B]=comparer) -> _A:
...
def min(xs: List[_A], comparer: IComparer[_A]) -> _A:
    def arrow_67(x: _A, y: _A=None, xs: List[_A]=xs, comparer: IComparer[_A]=comparer) -> _A:
...
def remove_at(index: int, xs: List[_T]) -> List[_T]:
    ...
    i : int = -1
    def predicate(_arg1: Any=None, index: int=index, xs: List[_T]=xs) -> bool:
        nonlocal i
        i = (i + 1) or 0
        return i != index
...
def remove_many_at(index: int, count: int, xs: List[_T]) -> List[_T]:
    i : int = -1
    status : int = -1
    def predicate(_arg1: Any=None, index: int=index, count: int=count, xs: List[_T]=xs) -> bool:
        nonlocal i, status
        i = (i + 1) or 0
        if i == index:
            status = 0
