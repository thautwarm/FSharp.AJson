...
def MapTreeLeaf_2__ctor_5BDDA1(k: Any, v: Any=None) -> MapTreeLeaf_2[_KEY, _VALUE]:
...
class MapTreeNode_2(MapTreeLeaf_2, Generic[_KEY, _VALUE]):
    def __init__(self, k: _KEY, v: _VALUE, left: Option[MapTreeLeaf_2[_KEY, _VALUE]], right: Option[MapTreeLeaf_2[_KEY, _VALUE]], h: int) -> None:
        super().__init__(k, v)
        self.left = left
        self.right = right
        self.h = h or 0
...
def MapTreeNode_2__ctor_Z39DE9543(k: _KEY, v: _VALUE, left: Option[MapTreeLeaf_2[_KEY, _VALUE]], right: Option[MapTreeLeaf_2[_KEY, _VALUE]], h: int) -> MapTreeNode_2[_KEY, _VALUE]:
    return MapTreeNode_2(k, v, left, right, h)


def MapTreeNode_2__get_Left(_: MapTreeNode_2[_KEY, _VALUE]) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    return _.left


def MapTreeNode_2__get_Right(_: MapTreeNode_2[_KEY, _VALUE]) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    return _.right
...
def MapTreeModule_empty() -> Option[MapTreeLeaf_2[Any, Any]]:
    return None


def MapTreeModule_sizeAux(acc_mut: int, m_mut: Option[MapTreeLeaf_2[Any, Any]]) -> int:
    while True:
        (acc, m) = (acc_mut, m_mut)
        if m is not None:
...
def MapTreeModule_size(x: Option[MapTreeLeaf_2[Any, Any]]=None) -> int:
    return MapTreeModule_sizeAux(0, x)


def MapTreeModule_mk(l: Option[MapTreeLeaf_2[_KEY, _VALUE]], k: _KEY, v: _VALUE, r: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    hl : int
    m : Option[MapTreeLeaf_2[_KEY, _VALUE]] = l
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
    ...
    hr : int
    m_1 : Option[MapTreeLeaf_2[_KEY, _VALUE]] = r
    if m_1 is not None:
...
def MapTreeModule_rebalance(t1: Option[MapTreeLeaf_2[_KEY, _VALUE]], k: _KEY, v: _VALUE, t2: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    t1h : int
    m : Option[MapTreeLeaf_2[_KEY, _VALUE]] = t1
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
    ...
    t2h : int
    m_1 : Option[MapTreeLeaf_2[_KEY, _VALUE]] = t2
    if m_1 is not None:
        m2_1 : MapTreeLeaf_2[_KEY, _VALUE] = m_1
    ...
    if t2h > (t1h + 2):
        ...
        if isinstance(match_value, MapTreeNode_2):
            def arrow_268(t1: Option[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Option[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
                m_2 : Option[MapTreeLeaf_2[_KEY, _VALUE]] = MapTreeNode_2__get_Left(match_value)
                if m_2 is not None:
        ...
        if isinstance(match_value_2, MapTreeNode_2):
            def arrow_269(t1: Option[MapTreeLeaf_2[_KEY, _VALUE]]=t1, k: _KEY=k, v: _VALUE=v, t2: Option[MapTreeLeaf_2[_KEY, _VALUE]]=t2) -> int:
                m_3 : Option[MapTreeLeaf_2[_KEY, _VALUE]] = MapTreeNode_2__get_Right(match_value_2)
                if m_3 is not None:
...
def MapTreeModule_add(comparer: IComparer[_KEY], k: _KEY, v: _VALUE, m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
...
def MapTreeModule_tryFind(comparer_mut: IComparer[_KEY], k_mut: _KEY, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> Option[_VALUE]:
    while True:
...
def MapTreeModule_find(comparer: IComparer[_KEY], k: _KEY, m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> _VALUE:
    match_value : Option[_VALUE] = MapTreeModule_tryFind(comparer, k, m)
...
def MapTreeModule_partition1(comparer: IComparer[_KEY], f: Any, k: _KEY, v: __A, acc1: Option[MapTreeLeaf_2[_KEY, __A]]=None, acc2: Option[MapTreeLeaf_2[_KEY, __A]]=None) -> Tuple[Option[MapTreeLeaf_2[_KEY, __A]], Option[MapTreeLeaf_2[_KEY, __A]]]:
    if f(k, v):
...
def MapTreeModule_partitionAux(comparer_mut: IComparer[_KEY], f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]], acc_0_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]], acc_1_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> Tuple[Option[MapTreeLeaf_2[_KEY, _VALUE]], Option[MapTreeLeaf_2[_KEY, _VALUE]]]:
    while True:
        (comparer, f, m, acc_0, acc_1) = (comparer_mut, f_mut, m_mut, acc_0_mut, acc_1_mut)
        acc : Tuple[Option[MapTreeLeaf_2[_KEY, _VALUE]], Option[MapTreeLeaf_2[_KEY, _VALUE]]] = (acc_0, acc_1)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
            if isinstance(m2, MapTreeNode_2):
                acc_2 : Tuple[Option[MapTreeLeaf_2[_KEY, _VALUE]], Option[MapTreeLeaf_2[_KEY, _VALUE]]] = MapTreeModule_partitionAux(comparer, f, MapTreeNode_2__get_Right(m2), acc[0], acc[1])
                acc_3 : Tuple[Option[MapTreeLeaf_2[_KEY, _VALUE]], Option[MapTreeLeaf_2[_KEY, _VALUE]]] = MapTreeModule_partition1(comparer, f, MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2), acc_2[0], acc_2[1])
                comparer_mut = comparer
                f_mut = f
...
def MapTreeModule_partition(comparer: IComparer[_KEY], f: Callable[[_KEY, __A], bool], m: Option[MapTreeLeaf_2[_KEY, __A]]=None) -> Tuple[Option[MapTreeLeaf_2[_KEY, __A]], Option[MapTreeLeaf_2[_KEY, __A]]]:
    return MapTreeModule_partitionAux(comparer, f, m, MapTreeModule_empty(), MapTreeModule_empty())


def MapTreeModule_filter1(comparer: IComparer[_KEY], f: Any, k: _KEY, v: __A, acc: Option[MapTreeLeaf_2[_KEY, __A]]=None) -> Option[MapTreeLeaf_2[_KEY, __A]]:
    if f(k, v):
...
def MapTreeModule_filterAux(comparer_mut: IComparer[_KEY], f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]], acc_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    while True:
        (comparer, f, m, acc) = (comparer_mut, f_mut, m_mut, acc_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
            if isinstance(m2, MapTreeNode_2):
                acc_1 : Option[MapTreeLeaf_2[_KEY, _VALUE]] = MapTreeModule_filterAux(comparer, f, MapTreeNode_2__get_Left(m2), acc)
                acc_2 : Option[MapTreeLeaf_2[_KEY, _VALUE]] = MapTreeModule_filter1(comparer, f, MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2), acc_1)
                comparer_mut = comparer
                f_mut = f
                m_mut = MapTreeNode_2__get_Right(m2)
                acc_mut = acc_2
...
def MapTreeModule_filter(comparer: IComparer[_KEY], f: Callable[[_KEY, __A], bool], m: Option[MapTreeLeaf_2[_KEY, __A]]=None) -> Option[MapTreeLeaf_2[_KEY, __A]]:
    return MapTreeModule_filterAux(comparer, f, m, MapTreeModule_empty())


def MapTreeModule_spliceOutSuccessor(m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Tuple[_KEY, _VALUE, Option[MapTreeLeaf_2[_KEY, _VALUE]]]:
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
        if isinstance(m2, MapTreeNode_2):
            if MapTreeNode_2__get_Left(m2) is None:
                ...
                pattern_input : Tuple[_KEY, _VALUE, Option[MapTreeLeaf_2[_KEY, _VALUE]]] = MapTreeModule_spliceOutSuccessor(MapTreeNode_2__get_Left(m2))
...
def MapTreeModule_remove(comparer: IComparer[_KEY], k: _KEY, m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
        c : int = comparer.Compare(k, MapTreeLeaf_2__get_Key(m2)) or 0
        if isinstance(m2, MapTreeNode_2):
            if c < 0:
                ...
                if MapTreeNode_2__get_Left(m2) is None:
                    ...
                    pattern_input : Tuple[_KEY, _VALUE, Option[MapTreeLeaf_2[_KEY, _VALUE]]] = MapTreeModule_spliceOutSuccessor(MapTreeNode_2__get_Right(m2))
...
def MapTreeModule_change(comparer: IComparer[_KEY], k: _KEY, u: Callable[[Option[_VALUE]], Option[_VALUE]], m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
        if isinstance(m2, MapTreeNode_2):
            c : int = comparer.Compare(k, MapTreeLeaf_2__get_Key(m2)) or 0
            if c < 0:
                ...
                match_value_1 : Option[_VALUE] = u(some(MapTreeLeaf_2__get_Value(m2)))
            ...
            if c_1 < 0:
                match_value_2 : Option[_VALUE] = u(None)
                ...
                match_value_3 : Option[_VALUE] = u(some(MapTreeLeaf_2__get_Value(m2)))
                ...
                match_value_4 : Option[_VALUE] = u(None)
        ...
        match_value : Option[_VALUE] = u(None)
...
def MapTreeModule_mem(comparer_mut: IComparer[_KEY], k_mut: _KEY, m_mut: Option[MapTreeLeaf_2[_KEY, Any]]) -> bool:
    while True:
        (comparer, k, m) = (comparer_mut, k_mut, m_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
...
def MapTreeModule_iterOpt(f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> None:
    while True:
        (f, m) = (f_mut, m_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
...
def MapTreeModule_iter(f: Callable[[__A, __B], None], m: Option[MapTreeLeaf_2[__A, __B]]=None) -> None:
    MapTreeModule_iterOpt(f, m)


def MapTreeModule_tryPickOpt(f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> Option[__A]:
    while True:
        (f, m) = (f_mut, m_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
            if isinstance(m2, MapTreeNode_2):
                match_value : Option[__A] = MapTreeModule_tryPickOpt(f, MapTreeNode_2__get_Left(m2))
                if match_value is None:
                    match_value_1 : Option[__A] = f(MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2))
...
def MapTreeModule_tryPick(f: Callable[[__A, __B], Option[__C]], m: Option[MapTreeLeaf_2[__A, __B]]=None) -> Option[__C]:
    return MapTreeModule_tryPickOpt(f, m)


def MapTreeModule_existsOpt(f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> bool:
    while True:
        (f, m) = (f_mut, m_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
...
def MapTreeModule_exists(f: Callable[[__A, __B], bool], m: Option[MapTreeLeaf_2[__A, __B]]=None) -> bool:
    return MapTreeModule_existsOpt(f, m)


def MapTreeModule_forallOpt(f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> bool:
    while True:
        (f, m) = (f_mut, m_mut)
        if m is not None:
            m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
...
def MapTreeModule_forall(f: Callable[[__A, __B], bool], m: Option[MapTreeLeaf_2[__A, __B]]=None) -> bool:
    return MapTreeModule_forallOpt(f, m)


def MapTreeModule_map(f: Callable[[_VALUE], _RESULT], m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _RESULT]]:
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
        if isinstance(m2, MapTreeNode_2):
            l2 : Option[MapTreeLeaf_2[_KEY, _RESULT]] = MapTreeModule_map(f, MapTreeNode_2__get_Left(m2))
            v2 : _RESULT = f(MapTreeLeaf_2__get_Value(m2))
            r2 : Option[MapTreeLeaf_2[_KEY, _RESULT]] = MapTreeModule_map(f, MapTreeNode_2__get_Right(m2))
...
def MapTreeModule_mapiOpt(f: Any, m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> Option[MapTreeLeaf_2[_KEY, _RESULT]]:
    if m is not None:
        m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
        if isinstance(m2, MapTreeNode_2):
            l2 : Option[MapTreeLeaf_2[_KEY, _RESULT]] = MapTreeModule_mapiOpt(f, MapTreeNode_2__get_Left(m2))
            v2 : _RESULT = f(MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2))
            r2 : Option[MapTreeLeaf_2[_KEY, _RESULT]] = MapTreeModule_mapiOpt(f, MapTreeNode_2__get_Right(m2))
            return MapTreeNode_2__ctor_Z39DE9543(MapTreeLeaf_2__get_Key(m2), v2, l2, r2, MapTreeNode_2__get_Height(m2))
...
def MapTreeModule_mapi(f: Callable[[__A, __B], __C], m: Option[MapTreeLeaf_2[__A, __B]]=None) -> Option[MapTreeLeaf_2[__A, __C]]:
    return MapTreeModule_mapiOpt(f, m)


def MapTreeModule_foldBackOpt(f_mut: Any, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]], x_mut: __A=None) -> __A:
    while True:
...
def MapTreeModule_foldBack(f: Callable[[__A, __B, __C], __C], m: Option[MapTreeLeaf_2[__A, __B]], x: __C=None) -> __C:
    return MapTreeModule_foldBackOpt(f, m, x)


def MapTreeModule_foldOpt(f_mut: Any, x_mut: __A, m_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]]) -> __A:
    while True:
...
def MapTreeModule_fold(f: Callable[[__A, __B, __C], __A], x: __A, m: Option[MapTreeLeaf_2[__B, __C]]=None) -> __A:
    return MapTreeModule_foldOpt(f, x, m)


def MapTreeModule_foldSectionOpt(comparer: IComparer[_KEY], lo: _KEY, hi: _KEY, f: Any, m: Option[MapTreeLeaf_2[_KEY, _VALUE]], x: __A=None) -> __A:
    def fold_from_to(f_1_mut: Any, m_1_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]], x_1_mut: __B=None, comparer: IComparer[_KEY]=comparer, lo: _KEY=lo, hi: _KEY=hi, f: Any=f, m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=m, x: __A=x) -> __B:
        while True:
            ...
            if m_1 is not None:
                ...
                if isinstance(m2, MapTreeNode_2):
                    ...
                    x_2 : __B = fold_from_to(f_1, MapTreeNode_2__get_Left(m2), x_1) if (c_lo_key < 0) else (x_1)
                    x_3 : __B = f_1(MapTreeLeaf_2__get_Key(m2), MapTreeLeaf_2__get_Value(m2), x_2) if (c_key_hi <= 0 if (c_lo_key <= 0) else (False)) else (x_2)
                    if c_key_hi < 0:
                        f_1_mut = f_1
...
def MapTreeModule_foldSection(comparer: IComparer[_KEY], lo: _KEY, hi: _KEY, f: Callable[[_KEY, __A, __B], __B], m: Option[MapTreeLeaf_2[_KEY, __A]], x: __B=None) -> __B:
    return MapTreeModule_foldSectionOpt(comparer, lo, hi, f, m, x)


def MapTreeModule_toList(m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=None) -> FSharpList[Tuple[_KEY, _VALUE]]:
    def loop(m_1_mut: Option[MapTreeLeaf_2[_KEY, _VALUE]], acc_mut: FSharpList[Tuple[_KEY, _VALUE]], m: Option[MapTreeLeaf_2[_KEY, _VALUE]]=m) -> FSharpList[Tuple[_KEY, _VALUE]]:
        while True:
...
def MapTreeModule_copyToArray(m: Option[MapTreeLeaf_2[__A, __B]], arr: List[Any], i: int) -> None:
    j : int = i or 0
    def arrow_270(x: Any, y: Any=None, m: Option[MapTreeLeaf_2[__A, __B]]=m, arr: List[Any]=arr, i: int=i) -> None:
        nonlocal j
        arr[j] = (x, y)
        j = (j + 1) or 0
...
def MapTreeModule_toArray(m: Option[MapTreeLeaf_2[__A, __B]]=None) -> List[Any]:
...
def MapTreeModule_ofList(comparer: IComparer[__A], l: FSharpList[Tuple[__A, __B]]) -> Option[MapTreeLeaf_2[__A, __B]]:
    def arrow_271(acc: Option[MapTreeLeaf_2[__A, __B]], tupled_arg: Tuple[__A, __B], comparer: IComparer[__A]=comparer, l: FSharpList[Tuple[__A, __B]]=l) -> Option[MapTreeLeaf_2[__A, __B]]:
        return MapTreeModule_add(comparer, tupled_arg[0], tupled_arg[1], acc)
    
    return fold_1(arrow_271, MapTreeModule_empty(), l)


def MapTreeModule_mkFromEnumerator(comparer_mut: IComparer[__A], acc_mut: Option[MapTreeLeaf_2[__A, __B]], e_mut: IEnumerator[Tuple[__A, __B]]) -> Option[MapTreeLeaf_2[__A, __B]]:
    while True:
        (comparer, acc, e) = (comparer_mut, acc_mut, e_mut)
        if e.System_Collections_IEnumerator_MoveNext():
            pattern_input : Tuple[__A, __B] = e.System_Collections_Generic_IEnumerator_00601_get_Current()
            comparer_mut = comparer
...
def MapTreeModule_ofArray(comparer: IComparer[_KEY], arr: List[Tuple[_KEY, _VALUE]]) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    res : Option[MapTreeLeaf_2[_KEY, _VALUE]] = MapTreeModule_empty()
...
def MapTreeModule_ofSeq(comparer: IComparer[_KEY], c: IEnumerable[Tuple[_KEY, _VALUE]]) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    if is_array_like(c):
...
class MapTreeModule_MapIterator_2(Record, Generic[_KEY, _VALUE]):
    def __init__(self, stack: FSharpList[Option[MapTreeLeaf_2[_KEY, _VALUE]]], started: bool) -> None:
        super().__init__()
        self.stack = stack
...
def MapTreeModule_collapseLHS(stack_mut: FSharpList[Option[MapTreeLeaf_2[_KEY, _VALUE]]]) -> FSharpList[Option[MapTreeLeaf_2[_KEY, _VALUE]]]:
    while True:
        (stack,) = (stack_mut,)
        if not is_empty_1(stack):
            rest : FSharpList[Option[MapTreeLeaf_2[_KEY, _VALUE]]] = tail(stack)
            m : Option[MapTreeLeaf_2[_KEY, _VALUE]] = head(stack)
            if m is not None:
                m2 : MapTreeLeaf_2[_KEY, _VALUE] = m
                if isinstance(m2, MapTreeNode_2):
...
def MapTreeModule_mkIterator(m: Option[MapTreeLeaf_2[__A, __B]]=None) -> MapTreeModule_MapIterator_2[__A, __B]:
...
def MapTreeModule_current(i: MapTreeModule_MapIterator_2[_KEY, _VALUE]) -> Any:
    if i.started:
        match_value : FSharpList[Option[MapTreeLeaf_2[_KEY, _VALUE]]] = i.stack
...
def MapTreeModule_mkIEnumerator(m: Option[MapTreeLeaf_2[__A, __B]]=None) -> IEnumerator[Any]:
    i : MapTreeModule_MapIterator_2[__A, __B] = MapTreeModule_mkIterator(m)
    class ObjectExpr273(IEnumerator[Any]):
        def System_Collections_Generic_IEnumerator_00601_get_Current(self, m: Option[MapTreeLeaf_2[__A, __B]]=m) -> Any:
            return MapTreeModule_current(i)
        
        def System_Collections_IEnumerator_get_Current(self, m: Option[MapTreeLeaf_2[__A, __B]]=m) -> Any:
            return MapTreeModule_current(i)
        
        def System_Collections_IEnumerator_MoveNext(self, m: Option[MapTreeLeaf_2[__A, __B]]=m) -> bool:
            return MapTreeModule_moveNext(i)
        
        def System_Collections_IEnumerator_Reset(self, m: Option[MapTreeLeaf_2[__A, __B]]=m) -> None:
            nonlocal i
            i = MapTreeModule_mkIterator(m)
        
        def Dispose(self, m: Option[MapTreeLeaf_2[__A, __B]]=m) -> None:
            pass
        
    return ObjectExpr273()


def MapTreeModule_toSeq(s: Option[MapTreeLeaf_2[__A, __B]]=None) -> IEnumerable[Any]:
    def generator(en_1: IEnumerator[Any], s: Option[MapTreeLeaf_2[__A, __B]]=s) -> Option[Tuple[Any, IEnumerator[Any]]]:
...
class FSharpMap(Generic[_KEY, _VALUE]):
    def __init__(self, comparer: IComparer[_KEY], tree: Option[MapTreeLeaf_2[_KEY, Any]]=None) -> None:
...
def FSharpMap__ctor(comparer: IComparer[_KEY], tree: Option[MapTreeLeaf_2[_KEY, Any]]=None) -> FSharpMap[_KEY, _VALUE]:
    return FSharpMap(comparer, tree)


def FSharpMap_Empty(comparer: IComparer[_KEY]) -> FSharpMap[_KEY, Any]:
    return FSharpMap__ctor(comparer, MapTreeModule_empty())


def FSharpMap__get_Comparer(m: FSharpMap[_KEY, Any]) -> IComparer[_KEY]:
    return m.comparer


def FSharpMap__get_Tree(m: FSharpMap[_KEY, _VALUE]) -> Option[MapTreeLeaf_2[_KEY, _VALUE]]:
    return m.tree


def FSharpMap__Add(m: FSharpMap[_KEY, _VALUE], key: _KEY, value: _VALUE=None) -> FSharpMap[_KEY, _VALUE]:
    return FSharpMap__ctor(m.comparer, MapTreeModule_add(m.comparer, key, value, m.tree))


def FSharpMap__Change(m: FSharpMap[_KEY, _VALUE], key: _KEY, f: Callable[[Option[_VALUE]], Option[_VALUE]]) -> FSharpMap[_KEY, _VALUE]:
...
def FSharpMap__get_Item(m: FSharpMap[_KEY, _VALUE], key: _KEY=None) -> _VALUE:
    return MapTreeModule_find(m.comparer, key, m.tree)


def FSharpMap__TryPick(m: FSharpMap[_KEY, _VALUE], f: Callable[[_KEY, _VALUE], Option[__A]]) -> Option[__A]:
...
def FSharpMap__Fold(m: FSharpMap[_KEY, _VALUE], f: Callable[[_KEY, _VALUE, __A], __A], acc: __A=None) -> __A:
    return MapTreeModule_foldBack(f, m.tree, acc)


def FSharpMap__FoldSection(m: FSharpMap[_KEY, _VALUE], lo: _KEY, hi: _KEY, f: Callable[[_KEY, _VALUE, _Z], _Z], acc: _Z=None) -> _Z:
...
def FSharpMap__Partition(m: FSharpMap[_KEY, _VALUE], predicate: Callable[[_KEY, _VALUE], bool]) -> Tuple[FSharpMap[_KEY, _VALUE], FSharpMap[_KEY, _VALUE]]:
    pattern_input : Tuple[Option[MapTreeLeaf_2[_KEY, _VALUE]], Option[MapTreeLeaf_2[_KEY, _VALUE]]] = MapTreeModule_partition(m.comparer, predicate, m.tree)
...
def FSharpMap__ContainsKey(m: FSharpMap[_KEY, Any], key: _KEY=None) -> bool:
    return MapTreeModule_mem(m.comparer, key, m.tree)


def FSharpMap__Remove(m: FSharpMap[_KEY, _VALUE], key: _KEY=None) -> FSharpMap[_KEY, _VALUE]:
    return FSharpMap__ctor(m.comparer, MapTreeModule_remove(m.comparer, key, m.tree))


def FSharpMap__TryGetValue(_: FSharpMap[_KEY, _VALUE], key: _KEY, value: Any) -> bool:
    match_value : Option[_VALUE] = MapTreeModule_tryFind(_.comparer, key, _.tree)
    if match_value is None:
        return False
...
def FSharpMap__TryFind(m: FSharpMap[_KEY, _VALUE], key: _KEY=None) -> Option[_VALUE]:
...
def change(key: __A, f: Callable[[Option[__B]], Option[__B]], table: FSharpMap[__A, __B]) -> FSharpMap[__A, __B]:
...
def try_find(key: __A, table: FSharpMap[__A, __B]) -> Option[__B]:
...
def try_pick(chooser: Callable[[__A, __B], Option[__C]], table: FSharpMap[__A, __B]) -> Option[__C]:
    return FSharpMap__TryPick(table, chooser)


def pick(chooser: Callable[[__A, __B], Option[__C]], table: FSharpMap[__A, __B]) -> __C:
    match_value : Option[__C] = try_pick(chooser, table)
    if match_value is not None:
        return value_1(match_value)
...
def fold_back(folder: Callable[[_KEY, _T, _STATE], _STATE], table: FSharpMap[_KEY, _T], state: _STATE=None) -> _STATE:
    return MapTreeModule_foldBack(folder, FSharpMap__get_Tree(table), state)


def to_seq(table: FSharpMap[__A, __B]) -> IEnumerable[Tuple[__A, __B]]:
    def mapping(kvp: Any, table: FSharpMap[__A, __B]=table) -> Tuple[__A, __B]:
        return (kvp[0], kvp[1])
...
def find_key(predicate: Callable[[__A, __B], bool], table: FSharpMap[__A, __B]) -> __A:
    def chooser(kvp: Any, predicate: Callable[[__A, __B], bool]=predicate, table: FSharpMap[__A, __B]=table) -> Option[__A]:
        k : __A = kvp[0]
...
def try_find_key(predicate: Callable[[__A, __B], bool], table: FSharpMap[__A, __B]) -> Option[__A]:
    def chooser(kvp: Any, predicate: Callable[[__A, __B], bool]=predicate, table: FSharpMap[__A, __B]=table) -> Option[__A]:
        k : __A = kvp[0]
        if predicate(k, kvp[1]):
            return some(k)
...
def of_seq(elements: IEnumerable[Tuple[_T, __A]], comparer: IComparer[_T]) -> FSharpMap[_T, __A]:
    return FSharpMap__ctor(comparer, MapTreeModule_ofSeq(comparer, elements))
...
def to_array(table: FSharpMap[__A, __B]) -> List[Any]:
...
def empty(comparer: IComparer[_KEY]) -> FSharpMap[_KEY, Any]:
